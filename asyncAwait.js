...
{
    let downloadAsync = await fetchData("google.com");
    console.log("downloading await completed");
    let filedownloaded = await writedata(downloadAsync);
    console.log("writing await completed");
    let uploadAsync = await upload(filedownloaded,"drive.com");
    console.log("uploading await completed");
    console.log("completed response",uploadAsync);
